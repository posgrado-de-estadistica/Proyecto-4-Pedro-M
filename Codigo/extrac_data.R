...
nacimientos_t %>% filter(cod_pc == "301") %>% 
    ...
    labs(x = "Año", y = "Cantidad de nacimientos", 
         title = "Nacimientos registrados en maestro de nacimientos provincia de Cartago cantón central")
dev.off()
...
nacimientos_t %>% filter(cod_pc == "101") %>% 
    ...
    geom_line() +
    labs(x = "Año", y = "Cantidad de nacimientos", 
         title = "Nacimientos registrados en maestro de nacimientos provincia de San josé cantón San josé")
dev.off()

pdf("Imagenes/exploratorio_3.pdf")
...
nacimientos_t %>% 
    ...
    geom_line() +
    labs(x = "Año", y = "Cantidad de nacimientos", 
         title = "Nacimientos registrados en maestro de nacimientos Costa Rica")
pdf("Imagenes/exploratorio_3.pdf")
dev.off()
...
nacimientos_t_spread_f <- nacimientos_t_spread %>% 
    dplyr::select(cod_pc,Provincia, Canton,tvim)
